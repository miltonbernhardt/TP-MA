...
public class GestorTitular {
    ...
    public List<Licencia> getHistorialLicencias(Integer idTitular){
        return (List<Licencia>) DAO.get().getResultList("select * from licencia where id_titular="+idTitular, Licencia.class);
    }
